...
params:
  weekonemonday: "2025-01-12"
  thesisdeadline: "2026-01-10"
  springbreak: "2025-03-7"
  name: Shatavia Bellmon
  labs: 6
  portfolios: 5
  grade:
    label: Grade
...
- [ ] `r advdate(dayone, 4, topic)`
  - Finish Lab 4  by 2`r startweek`:  `r advdate(dayone, 4, assignment=startweek)`
...
- [ ] Portfolio completion and end-of-semester presentation
  - Due on `r startweek`: `r advdate(dayone, 7, assignment=startweek)`
